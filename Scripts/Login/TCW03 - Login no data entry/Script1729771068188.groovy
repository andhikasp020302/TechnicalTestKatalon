...
WebUI.waitForElementPresent(findTestObject('Halaman Login/span_Email Wajib Diisi'), 0)

WebUI.waitForElementPresent(findTestObject('Halaman Login/span_Password Wajib Diisi'), 0)
